# Generated by Django 3.2.8 on 2021-10-16 14:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(upload_to=server.models.user_directory_path_picture)),
                ('banner', models.ImageField(upload_to=server.models.user_directory_path_banner)),
                ('title', models.CharField(max_length=144)),
                ...
                ('server_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='server.servercategory')),
